...
#Date: 7/22/2014 to 7/24/2014, modified on 3/29/2016, modified on 4/25/2018, 7/11/2018, and 9-10/2018 through 2019 and 2020
...
for n in range(1,(MonteCarlo_runs+1)):
    ...
    for pname,minimum,baseline,maximum,distributiontype in prange:
        if distributiontype=="weighed\n" or distributiontype=="weighed":
            ...
            pvalue=choice(weighedparametervalue,1,p=weighedprob)
            pvalue=pvalue[0]
